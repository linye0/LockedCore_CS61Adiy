...
def inc_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = subseq_helper(s[1:], prev)#condition:n+1
            b = subseq_helper(s[1:], s[0])#condition:n
...
def make_glookup(class_assignments):
    ...
    score_total = 0
    score_sofar = 0
    def look_up(section, score_earn):
        nonlocal score_total, score_sofar
        score_total += class_assignments[section]
        score_sofar += score_earn
        return score_sofar / score_total
    return look_up
