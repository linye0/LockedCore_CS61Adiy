...
def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        current = False
        for a in branches(t):
            current = current or berry_finder(a)
        return current
...
def add_trees(t1, t2):
    ...
    if is_leaf(t1):
        ...
        branches1 = fewer_branches + [tree(0) for __ in range(len(more_branches) - len(fewer_branches))]
        branches2 = more_branches
